...
<body>
    ...
    <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Attendance_date" ItemStyle-HorizontalAlign="Center">
    <ItemTemplate>
        <asp:Label ID="Label3" runat="server" Text='<%# Bind("Attendance_date") %>' CssClass="tableLabel"></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>

          <asp:TemplateField HeaderText="status" ItemStyle-HorizontalAlign="Center">
    <ItemTemplate>
        <asp:Label ID="Label4" runat="server" Text='<%# Bind("status") %>' CssClass="tableLabel"></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
