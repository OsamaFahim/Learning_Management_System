...
public partial class ViewAttendance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Postback || eventTarget == null)
        {
            ...
            {
                getStudentID();
                string query = "select studentcourse.courseid, coursename, attendance_date, attendance.status \r\nfrom studentcourse\r\njoin courses on studentcourse.courseid = courses.courseid\r\n" +
                    "join attendance on attendance.studentid = studentcourse.studentid and attendance.courseid = studentcourse.courseid \r\nwhere studentcourse.studentid = @SID and courses.courseid = @CID;\r\n";
