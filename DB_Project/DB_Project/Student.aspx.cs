...
public partial class Student : System.Web.UI.Page
{
    ...
    protected void loginButton_Click(object sender, EventArgs e)
    {
        ...
        string query = "select *from [User] where [User].Username = '" + username + "' and [User].Password = '" + password + "' and [User].Role = 'Student'";
        ...
        {
            dr.Close();
            Response.Redirect("~/StudentMenu.aspx?UserName=" + this.username.Text);
        }
        else
        {
