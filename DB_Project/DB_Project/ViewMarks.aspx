...
<body>
    ...
    <ItemTemplate>
        <asp:Label ID="Category" runat="server" Text='<%# Bind("Category") %>' CssClass="tableLabel"></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
      
       <asp:TemplateField HeaderText="Weightage" ItemStyle-HorizontalAlign="Center">
    <ItemTemplate>
        <asp:Label ID="Weightage" runat="server" Text='<%# Bind("Weightage") %>' CssClass="tableLabel"></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>

        <asp:TemplateField HeaderText="Obtained" ItemStyle-HorizontalAlign="Center">
    <ItemTemplate>
        <asp:Label ID="Label3" runat="server" Text='<%# Bind("Obtained") %>' CssClass="tableLabel"></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
